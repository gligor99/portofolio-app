      ...
      <div className="name">
        <Slide left>
          ...
          <p className="details">
            ...
            beatae incidunt! Dolor praesentium, aliquam dicta minima fuga amet
            dolore omnis autem? Praesentium, ea mollitia? Libero repudiandae
            animi molestiae velit sint?
          </p>
          <div className="header-btns">
            ...
            <a
              href="/"
              download="https://drive.google.com/file/d/1z_kut70m208BGZbxChukJ0nACA8eOBp9/view?usp=sharing"
              className="btn-2"
            >
              Download CV
            </a>
